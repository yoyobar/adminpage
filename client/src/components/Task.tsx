...
export default function Task() {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="font-mono flex select-none w-full bg-slate-50 items-center gap-4 border-b transition dark:border-black dark:bg-slate-700 dark:text-white  p-2">
